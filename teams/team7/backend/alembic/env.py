...
Reads `DATABASE_URL` from `app.core.config.Settings` so the same .env used by
the FastAPI app drives migrations. The connection is async, matching the
runtime SQLAlchemy engine.
"""
